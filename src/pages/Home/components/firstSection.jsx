...
export const FirstSection = () => {
    ...
    return (
        <>
                <div className='w-[30%] my-10 mx-auto'>
                    <svg
            ...
            <div className='flex flex-wrap gap-3 justify-center p-3 font-custom'>
                {
                    suwar.map((element, index) =>
                        <>
                            <div onClick={(e) => readSurah(element.number)} className='border-2 rounded-sm  border-[#3941295a] w-[10%] px-2 py-2 gap-3 flex flex-col justify-between items-center font-bold cursor-pointer hover:bg-[#f7e6c8]'>
                                <div className='bg-[#d4e096] px-4 py-2 rounded-lg'>{element.number}</div>
